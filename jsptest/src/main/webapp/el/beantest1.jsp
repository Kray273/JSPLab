...
<jsp:setProperty property="id" name="dto" value="elbean"/>
<jsp:setProperty property="pw" name="dto" value="elpw"/>
<jsp:setProperty property="name" name="dto" value="el"/>
<jsp:setProperty property="email" name="dto" value="el@mail.com"/>
<jsp:setProperty property="phone" name="dto" value="0101111111"/>
<jsp:setProperty property="address" name="dto" value="서울시 el"/>
...
<H1> 회원정보를 생성 완료했습니다. 확인해 볼까요?(getter)</H1>
<h3>아이디 : <%=dto.getId()%></h3>
